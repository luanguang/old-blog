...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ url('assets/admin/skin/default_skin/css/theme.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ url('assets/admin/admin-tools/admin-forms/css/admin-forms.css') }}">
...
<body class="external-page sb-l-c sb-r-c">
          ...
          <div class="row mb15 table-layout">
            <div class="col-xs-6 va-m pln">
              <a href="dashboard.html" title="Return to Dashboard">
                <img src="{{ url('assets/admin/img/logos/logo_white.png') }}" title="AdminDesigns Logo" class="img-responsive w250">
              </a>
            </div>
  ...
  <script src="{{ url('assets/admin/js/utility/utility.js') }}"></script>
